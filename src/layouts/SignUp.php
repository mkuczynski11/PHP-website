...
<body onload="setStorage()">
  ...
  <main>
    <section id="text">
      ...
      <p>Formularz do rejestacji</p>
      <form action="/signup/add" method="POST">
        Adres e-mail:<input type="email" name="email" placeholder="E-mail"> <br>
        Login:<input type="text" name="login" placeholder="Login"> <br>
				Hasło:<input type="password" name="password" placeholder="Hasło"> <br>
        Powtórz hasło:<input type="password" name="repeat" placeholder="Powtórz hasło"> <br>
